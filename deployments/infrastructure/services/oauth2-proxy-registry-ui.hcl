### oauth2-proxy: OIDC forward-gate for registry-ui. A copy of
### oauth2-proxy.hcl, which says this pattern is meant to be copied:
...
job "oauth2-proxy-registry-ui" {
  datacenters = ["localstack"]
  type        = "service"
  namespace   = "default"

  group "oauth2-proxy-registry-ui" {
    constraint {
    ...
    task "oauth2-proxy" {
      ...
      template {
        ...
        OAUTH2_PROXY_UPSTREAMS="${frontend_upstream},${backend_upstream}"
